  ...
  return (
    <div className="container">
      <div className="page-header">
        <h1>Orden #{nroOrden || orden.id} {estadoBadge(orden.estado)}</h1>
        <div className="actions-bar no-print">
          {canPrint && <button className="btn btn-secondary" onClick={handlePrint}>Imprimir</button>}
      ...
      <div className="card">
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: 001"
              style={{ border:'1px solid #ccc', borderRadius:4, padding:'2px 8px', width:100 }}
            />
          </div>
        ...
        {orden.notas_gerente && <div style={{ marginTop:12 }}><strong>Notas del gerente:</strong> {orden.notas_gerente}</div>}
      </div>
      ...
      <div className="card">
        ...
        <div className="table-wrapper">
          <table className="items-table">
            <thead>
              <tr><th>#</th><th>Producto</th><th>Cantidad</th><th>Habitacion</th><th>Motivo</th></tr>
            </thead>
            <tbody>
